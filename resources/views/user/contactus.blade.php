   ...
   <div class="auto-container">
      <div class="row clearfix">
         ...
         <div class="col-lg-6 col-md-12 col-sm-12 map-column">
            <div class="map-inner">
               <div class="pattern" style="background-image: url(assets/images/shape/shape-90.png);"></div>
               <div 
                  class="google-map" 
                  id="contact-google-map" 
                  data-map-lat="{{Config::get('mapdetail.lat')}}" 
                  data-map-lng="{{Config::get('mapdetail.long')}}" 
                  data-icon-path="{{asset('public/front_pro/assets/images/icons/map-marker.png')}}"
                  data-map-zoom="12" 
                  >
               </div>
            </div>

            ...
            <div class="auto-container">
                <div class="inner-box">
                    <div class="content-box">
                        <div class="title-box">
                            <h3>{{__('message.Doctor Login')}}</h3>
                            <a href="{{url('doctorregister')}}">{{__('message.Not a Doctor')}}</a>
                        </div>
                        <div class="inner">
                            ...
                            <form action="{{url('postlogindoctor')}}" method="post" class="registration-form">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        ...
                                        <input type="email" name="email" id="email" placeholder="{{__('message.Your email')}}" required="" value="{{isset($_COOKIE['email'])?$_COOKIE['email']:''}}">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">

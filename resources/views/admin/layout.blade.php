...
<html lang="en">
   ...
   <body>
            ...
            <div class="navbar-header">
               ...
               <div class="d-flex">
                  ...
                  <div class="dropdown d-inline-block">
                     ...
                     <img class="rounded-circle header-profile-user" src="{{asset('upload/profile/').'/'.Sentinel::getUser()->profile_pic}}" alt="Header Avatar" />
               ...
               <div id="sidebar-menu">
                  <ul class="metismenu list-unstyled" id="side-menu">
                     ...
                     <li>
                      ...
                      <li>
                        <a href="{{url('admin/typeservices')}}" class="waves-effect">
                        <i class="uil-servicemark"></i>
                        <span>{{__("message.Type Service")}}</span>
                        </a>
                     </li>
      ...
      <script type="text/javascript" src="{{asset('js/admin.js?v=21')}}"></script>
      ...
      <script src="{{asset('admin_design/layouts/vertical/assets/js/jquery.mask.min.js')}}"></script>
      <script>
          function disablebtn(){
